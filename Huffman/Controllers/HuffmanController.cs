...
namespace Huffman.Controllers
{
    ...
    public class HuffmanController : ControllerBase
    {
        ...
        private readonly Compresion HuffCompress = new Compresion();
        readonly Compresion HuffDesc = new Compresion();
        ...
        public void HuffmanCompress(FileUploadAPI objFile, string id)
        {
            ...
            HuffCompress.Comprimir(_environment.WebRootPath + "\\UploadHuffman\\" + objFile.Files.FileName, _environment.WebRootPath + "\\UploadHuffman\\" + id + ".huff", FileName1[0], _environment.WebRootPath + "\\UploadHuffman\\" + "Compresiones.txt");
        ...
        {
            string[] FileName1 = objFile.Files.FileName.Split(".");
            HuffDesc.Descomprimir(_environment.WebRootPath + "\\UploadHuffman\\" + objFile.Files.FileName, _environment.WebRootPath + "\\UploadHuffman\\" + FileName1[0] + ".txt");
